...
class UpdateClassResult(BaseModel):
    id: UUID
...
async def update_class(
    ...
    *,
    ...
    parsed = await asyncio.to_thread(
        parse_raw_as, UpdateClassResult | None, resp, json_loads=orjson.loads
    )
    return cast(UpdateClassResult | None, parsed)
